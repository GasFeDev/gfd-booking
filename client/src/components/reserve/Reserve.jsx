...
const Reserve = ({ setOpen, hotelId }) => {
  ...
  const getDatesInRange = (startDate, endDate) => {
    ...
    /* Los objetos Date representan un momento fijo en el tiempo en un formato independiente. El objeto Date contiene un Number que representa los milisegundos transcurridos desde el 1 de Enero de 1970 UTC. */
        ...
        {data.map((item) => (
          <div className="rItem" key={item._id}>
            <div className="rItemInfo">
              ...
              <div className="rMax">
                Máximo de personas: <b>{item.maxPeople}</b>
              </div>
